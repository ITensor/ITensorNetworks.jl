...
function identityITensorNetwork(s; link_space = nothing)
  ...
  function ising_partition_function_ITensorNetwork(g::NamedDimGraph, beta::Float64; szverts=nothing)
  ...
  function ising_partition_function_ITensorNetwork(s::IndsNetwork, beta::Float64; szverts=nothing)
