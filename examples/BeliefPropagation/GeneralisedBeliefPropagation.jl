...
println("Random Regular Graph, "*string(n)*" sites")
...
println("Using 1 Site Subgraphs, Average Error (In Terms of Abs Diff) on Local values of Sz is "*string(sum(err)/n))
...
println("2D Grid, "*string(n1)*" x "*string(n2))
...
println("Using 4 Site Subgraphs, Average Error (In Terms of Abs Diff) on Local values of Sz is "*string(sum(err)/n))
